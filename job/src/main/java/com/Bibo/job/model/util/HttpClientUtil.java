package com.Bibo.job.model.util;
...
public class HttpClientUtil {
    ...
    @Value("${header.token}")
//    private static final String HEADER_TOKEN = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJrai11c2VyIiwiaWF0IjoxNjQ0MzA1MDY4LCJleHAiOjE2NDQzNzcwNjgsInVzZXJuYW1lIjoiYWRtaW4ifQ.iKEKjYgysBnu8cCsPDO4Dr4YePC31qY28XEnZjYQNnY";
    ...
    public static String doGet(String url) {
        ...
        try {
            ...
            getMethod.addRequestHeader(HEAD, HEAD_TOKEN);
