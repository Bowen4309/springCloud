...
@Data
@ApiModel(value = "SysCustomFormListDto",description = "自定义表单列表对象")
public class SysCustomFormListDto implements Serializable {
    ...
    @ApiModelProperty(value = "下一层级")
    List<SysCustomFormListDto> forms;
